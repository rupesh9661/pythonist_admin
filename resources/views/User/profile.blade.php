    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          <img src="{{asset('images/profile_images/'.$user->profile_image)}}" alt="Profile" class="rounded-circle">
          @else
          <img src="{{asset('assets/img/profile-img.jpg')}}" alt="Profile" class="rounded-circle">
          @endif
          <h2>{{$user->name}}</h2>
          <div class="social-links mt-2">
            <a href="{{$user->twitter_profile}}" target="_blank" class="twitter"><i class="bi bi-twitter"></i></a>
            <a href="{{$user->facebook_profile}}" target="_blank" class="facebook"><i class="bi bi-facebook"></i></a>
              ...
              <form method="POST" action="{{url('update_profile')}}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    @if(!empty($user->profile_image))
                    <img src="{{asset('images/profile_images/'.$user->profile_image)}}" alt="Profile">
                    @else
                    <img src="{{asset('assets/img/profile-img.jpg')}}" alt="Profile" class="rounded-circle">
                    @endif
                    <div class="pt-2">
                      ...
                      <label for="image" class="col-form-label">Upload New Profile Image</label>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="twitter" type="text" class="form-control" id="twitter" value="{{$user->twitter_profile}}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="facebook" type="text" class="form-control" id="facebook" value="{{$user->facebook_profile}}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="instagram" type="text" class="form-control" id="instagram" value="{{$user->instagram_profile}}">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="linkedin" type="text" class="form-control" id="linkedin" value="{{$user->linkedin_profile}}">
                  </div>
                </div>
